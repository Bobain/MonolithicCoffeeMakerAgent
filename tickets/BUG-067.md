# BUG-067: CFR-014 violation: orchestrator using JSON files instead of database

**Status**: 🟡 In Progress
**Priority**: High
**Created**: 2025-10-20T16:24:10.944974
...
**Test File**: _Path to test file (e.g., `tests/test_bug_067_cfr-014_violation:_orchestrato.py`)_

**Test Name**: _Test function name (e.g., `test_bug_067_reproduction`)_

...
Example:
    Create tables:
    >>> from coffee_maker.langchain_observe.analytics.models_sqlite import init_database
    >>>
    ...
    >>> import sqlite3
    >>> from coffee_maker.langchain_observe.analytics.models_sqlite import Gener

...
from coffee_maker.utils.response_parser import (
    extract_token_usage,
    is_quota_exceeded_error,
    is_rate_limit_error,
)
from coffee_maker.llm.strategies.context import ContextStrategy, create_context_strategy
from coffee_maker.llm.strategies.fallback import FallbackStrategy, SequentialFallback
from coffee_maker.llm.strategies.metrics import MetricsStrategy, NoOpMetrics
...
class AutoPickerLLMRefactored(BaseLLM):
    ...
    def _try_invoke_model(
        ...
        if not fits:
            ...
            if large_model_names:
                ...
                for large_llm, large_model_name in large_models:
                    ...
                    if result is not None:
                        ...
                        if self._langfuse_logger:
                            from coffee_maker.llm.config import (
            ...
            from coffee_maker.llm.config import get_all_model_context_limits

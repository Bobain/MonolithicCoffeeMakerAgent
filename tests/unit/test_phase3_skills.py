...
- code-forensics (assistant (using code analysis skills))
...
class TestCodeForensicsSkill:
    """Tests for code-forensics skill (assistant (using code analysis skills))."""

    def test_code_forensics_execution(self):
        """Test that code-forensics skill executes successfully."""
        skill_path = Path(".claude/skills/assistant (using code analysis skills)/code-forensics/code_forensics.py")
...
class TestPhase3Integration:
    ...
    def test_all_phase3_skills_exist(self):
        ...
        skills = [
            ".claude/skills/assistant (using code analysis skills)/code-forensics/code_forensics.py",
    ...
    def test_all_phase3_skill_metadata_exist(self):
        ...
        metadata_files = [
            ".claude/skills/assistant (using code analysis skills)/code-forensics/SKILL.md",

...
This guide describes the architect agent's daily integration workflow for assistant (using code analysis skills) findings and weekly codebase analysis, as required by CFR-011.

**Key Principle**: architect MUST integrate assistant (using code analysis skills) findings daily and analyze the codebase weekly BEFORE creating new technical specifications.
...
1. **Read ALL assistant (using code analysis skills) reports** in `docs/assistant (using code analysis skills)/*.md`
...
Last assistant (using code analysis skills) read: 2025-10-18
...
**What this does**:
1. Finds all unread assistant (using code analysis skills) reports
...
**Example Session**:
```
=== Found 2 unread assistant (using code analysis skills) report(s):
...
Unread assistant (using code analysis skills) reports: SECURITY_AUDIT_2025-10-18.md
...
2. **Integrate findings**: Use assistant (using code analysis skills) insights to improve spec quality
...
Guided workflow for reading assistant (using code analysis skills) reports.
...
- [SPEC-054: Technical Specification](specs/SPEC-054-architect-assistant (using code analysis skills)-daily-integration.md)
- [assistant (using code analysis skills) Documentation](.claude/agents/assistant (using code analysis skills).md)

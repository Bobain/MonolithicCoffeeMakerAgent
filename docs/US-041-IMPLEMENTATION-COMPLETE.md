...
- **code-searcher**: Lists CLAUDE.md, own role definition as mandatory
...
- ✅ code-searcher listed in .claude/agents/README.md
...
.claude/agents/README.md  (+80 lines)
  ...
  - Added code-searcher agent description and usage
...
Additionally, code-searcher and ux-design-expert are now also discoverable, making the entire agent ecosystem complete.
